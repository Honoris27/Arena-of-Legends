        ...
        <div className={player.activeExpedition ? 'opacity-50 pointer-events-none' : ''}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {locations.filter(l => l.regionId === selectedRegion.id).map(loc => {
                    ...
                    return (
                        <div key={loc.id} className={`bg-slate-800 border ${canEnter ? 'border-slate-700 hover:border-red-500' : 'border-slate-800 opacity-60'} transition-all rounded-xl p-6 flex flex-col justify-between relative overflow-hidden group`}>
                             {!canEnter && (
                             ...
                             <div>
                                ...
                                <div className="grid grid-cols-2 gap-2 text-xs mb-4">
                                    ...
                                    <div className="bg-slate-900 p-2 rounded text-center">
                                        <span className="block text-slate-500 mb-1">Ödül Oranı</span>
                                        <span className="font-bold text-green-400">x{loc.rewardRate}</span>
                                    </div>
                                </div>
                             </div>
                             <button
